...
#define RS485UART_MODE_RECEIVE      2
 ...
 #define ATMEGA_USART0
 #define ATMEGA_USART1
 #define UART0_RECEIVE_INTERRUPT   UART0_RX_vect
 #define UART1_RECEIVE_INTERRUPT   UART1_RX_vect
 #define UART0_TRANSMIT_INTERRUPT  UART0_UDRE_vect
 #define UART1_TRANSMIT_INTERRUPT  UART1_UDRE_vect
 #define UART0_STATUS   UCSR0A
 #define UART0_CONTROL  UCSR0B
 #define UART0_DATA     UDR0
 #define UART0_UDRIE    UDRIE0
 ...
 #define ATMEGA_USART
 #define UART0_RECEIVE_INTERRUPT   USART0_RX _vect
 #define UART0_TRANSMIT_INTERRUPT  USART0_UDRE_vect
 #define UART0_STATUS   UCSRA
 #define UART0_CONTROL  UCSRB
 #define UART0_DATA     UDR
